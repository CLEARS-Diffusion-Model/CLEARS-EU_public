...
import support.read_inputs as r_f
import npv_calculation as npv_calc
import bass_model as bm
import system_impacts as si
from base_battery_use import base_battery_use
from peak_battery_use import peak_battery_use
from smooth_battery_use import smooth_battery_use
import peak_hours as peak
...
#        # Load historical data, exogenous assumptions
    ...
    def solve(self):
        ...
        # for f in [0, 1]:
            ...
            print('Iteration:', f)
            f = int(f)
            # self.data['feed_in_tariff'][:, 0, 0, 0, 0, 0, 0] = np.repeat(0.01, len(self.titles['country'])) * f
